...
pub type GetAccountIdentifierTransactionsResult = std::result::Result<
  GetAccountIdentifierTransactionsResponse, GetAccountIdentifierTransactionsError
>;
#[derive(CandidType, Deserialize)]
pub struct Account {
  pub owner: Principal,
...
impl Service {
  pub async fn get_account_identifier_balance(&self, arg0: &String) -> Result<(u64,)> {
    ic_cdk::call(self.0, "get_account_identifier_balance", (arg0,)).await
  }
  pub async fn get_account_identifier_transactions(&self, arg0: &GetAccountIdentifierTransactionsArgs) -> Result<(GetAccountIdentifierTransactionsResult,)> {
    ic_cdk::call(self.0, "get_account_identifier_transactions", (arg0,)).await
  }
  pub async fn get_account_transactions(&self, arg0: &GetAccountTransactionsArgs) -> Result<(GetAccountIdentifierTransactionsResult,)> {
